...
namespace restapi.Models
{
    public class Timecard
    {
        ...
        public TimecardLine FindLine(Guid lineId)
        {
            return Lines.SingleOrDefault(x => x.UniqueIdentifier == lineId);
        }

        public void DeleteLine(Guid lineId)
        {
            Lines.Remove(Lines.SingleOrDefault(x => x.UniqueIdentifier == lineId));
        }


        public TimecardLine ReplaceLine(Guid lineToReplaceId, DocumentLine documentLine)
        {
            TimecardLine annotatedLine = FindLine(lineToReplaceId);

            annotatedLine.Update(documentLine);
        ...
        public bool CanUpdateLine()
        {
            return (Status == TimecardStatus.Draft);
        }
