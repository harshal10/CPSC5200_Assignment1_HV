...
namespace restapi.Controllers
{
    ...
    public class TimesheetsController : Controller
    {
        ...
        [ProducesResponseType(404)]
        [ProducesResponseType(typeof(TimecardPersonError), 403)]
        ...
        [ProducesResponseType(typeof(TimecardPersonError), 403)]
        public IActionResult AddLine(Guid id, [FromQuery]int reqid, [FromBody] DocumentLine documentLine)
        {
            logger.LogInformation($"Looking for timesheet {id}");
        ...
        [ProducesResponseType(typeof(InvalidStateError), 409)]
        [ProducesResponseType(typeof(EmptyTimecardError), 409)]
        [ProducesResponseType(typeof(SelfApprovalError), 403)]
        public IActionResult Approve(Guid id, [FromBody] Approval approval)
        {
            ...
            if (timecard != null)
            {
                ...
                {
                    return StatusCode(403, new SelfApprovalError() { });
                }
